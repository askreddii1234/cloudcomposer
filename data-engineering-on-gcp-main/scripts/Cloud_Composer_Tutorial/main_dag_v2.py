...
trigger_external_dag = TriggerDagRunOperator(
    ...
    trigger_dag_id='external_dag_v2',  # Replace with the actual DAG ID to trigger
...
wait_for_external_task = ExternalTaskSensor(
    ...
    external_dag_id='external_dag_v2',  # Replace with the actual DAG ID of the external DAG
